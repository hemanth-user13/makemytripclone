...
const FlightBookingForm = () => {
    ...
    return (
        <div className="" style={{position:"relative",top:"250px",left:"180px"}}>
            <div
                className="absolute transform -translate-y-1/2 mx-auto w-full max-w-6xl p-4"
                ...
                <div className="bg-white shadow-md rounded-lg p-8 border-2 border-gray-200">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div
                            ...
                            style={{ position: "absolute", bottom: "220px",top:"170px", left: "540px" }}
                        >
                            <DatePicker
